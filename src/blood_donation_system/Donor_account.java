...
public class Donor_account extends javax.swing.JFrame {
    ...
    public Donor_account( String user) {
        try {
            ...
            Connection con=DriverManager.getConnection("jdbc:mysql://localhost/bbank","root","");
            Statement st=con.createStatement();
            ResultSet rs= st.executeQuery("select * from donor where user='"+user+"'");
            rs.next();
            type=rs.getString(3);
    ...
    private void initComponents() {
        ...
        jLabel17.setText("  Blood Bank Management System  For Matoshree Hospital");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addComponent(jLabel17, javax.swing.GroupLayout.PREFERRED_SIZE, 1019, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            ResultSet rs=st.executeQuery("select * from available_packet where name='"+type+"'");
            rs.next();
            int no=Integer.parseInt(rs.getString(2));
            no=no+1;
            JOptionPane.showMessageDialog(this,"THANK YOU FOR DONATION!!");
            PreparedStatement st2=con.prepareStatement("update available_packet set available='"+no+"' where name='"+type+"'");
            st2.executeUpdate();
